...
import { allowedSmartContracts } from "./excluded-sc";
...
//     status: "success",
//     receiver: "erd1qqqqqqqqqqqqqpgqyx43t88dek9yr4889ykzx0wuz3kfwd4a2jps9xnxhm",
//     size: 50,
//     withScResults: true,
//   });
...
//           const decodedResult = Buffer.from(result, "hex").toString("utf-8");

//           console.log("decodedResult", decodedResult);

//           if (decodedResult === selectedNetwork.tokensID.jeet) {
//             hasInteracted = true;
//           }
//         } catch (error) {
...
export const UserAddressHasInteracted = async (payload: {
  ...
  for (let index = 0; index < scAddressArr.length && !hasInteracted; index++) {
    ...
    if (!allowedSmartContracts.includes(addressElement[0])) {
      continue;
    }
